class ProfilesFutureList {
  int? statusCode;
  bool? apiStatus;
  int? totalCount;
  List<ResultFuture>? result;

  ProfilesFutureList(
      {this.statusCode, this.apiStatus, this.totalCount, this.result});

  ProfilesFutureList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['result'] != null) {
      ...
      json['result'].forEach((v) {
        result!.add(ResultFuture.fromJson(v));
      });
    }
  }
...
class ResultFuture {
  int? isMultiLocation;
  int? isAlternateDatesExist;
  int? isAlternateDatesCount;
  ...
  ResultFuture(
      ...
      this.isAlternateDatesExist,
      this.isAlternateDatesCount,
      this.engagementType,
      this.id,
      this.user,
      this.topic,
  ...
  ResultFuture.fromJson(Map<String, dynamic> json) {
    isMultiLocation = json['is_multi_location'];
    isAlternateDatesExist = json['is_alternate_dates_exist'];
    isAlternateDatesCount = json['is_alternate_dates_count'];
    ...
    // if (json['primaryMeeting'] != null) {
    //   primaryMeeting = <Null>[];
    //   json['primaryMeeting'].forEach((v) {
    //     primaryMeeting!.add(Null.fromJson(v));
    //   });
    // }
    // hcpOrRep = json['hcpOrRep'].cast<String>();
    invited = json['invited'];
    confirmedInvitees = json['confirmed_invitees'];
    if (json != null && json['hcpOrRep'] != null) {
      hcpOrRep = (json['hcpOrRep'] as List<dynamic>).cast<String>();
    } else {
      // Handle the case where json or json['hcpOrRep'] is null
    }

    participantStatus = json['participantStatus'] != null
        ? ParticipantStatus.fromJson(json['participantStatus'])
        : null;
    ...
    if (json['speaker_data'] != null) {
      ...
      json['speaker_data'].forEach((v) {
        speakerData!.add(SpeakerData.fromJson(v));
      });
    }
    location =
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_alternate_dates_exist'] = isAlternateDatesExist;
    data['is_alternate_dates_count'] = isAlternateDatesCount;
    ...
    //   data['primaryMeeting'] =
    //       primaryMeeting!.map((v) => v.toJson()).toList();
    // }
    data['invited'] = invited;
    data['confirmed_invitees'] = confirmedInvitees;
    data['hcpOrRep'] = hcpOrRep;
    if (participantStatus != null) {
      data['participantStatus'] = participantStatus!.toJson();
    }
...
class EngagementType {
  String? isVideoSessionTestLinkEnabled;
  String? isAddTimezoneAtCreate;
  String? isAlternateDatesAvailable;
  String? maxNumberSpk;
  String? isMissingEmailFlagEnable;
  ...
  String? updatedAt;
  int? venueType;
  String? isDmSigninWithoutJoin;
  String? isCreateEngagemetSpkObject;
  String? hcpMinimumCollab;
  String? isSpeakerEndSessionDisable;
  String? isAlternateVenueEnable;
  String? alternateVenueCount;
  String? skipStartEngagement;
  String? isCreateEngagementSuccessMessage;
  String? speakerSignOnPaperCheckboxDisable;
  String? locationBasedFfsCalculation;
  String? shionogiRoundtableCheck;
  String? maxCoHost;
  String? coHostMessage;
  String? coHostPopUpMessage;
  String? shionogiRoundtableHcpMaxCheck;
  String? isUploadDocument;
  String? isUploadDocumentEnabled;
  String? isExihibitDetails;
  String? displayAndExhibiWorkflow;
  String? isCohostDidnotAttendEnabled;
  String? hideReceiptUploadCheckbox;
  String? virtualWindowUpdatePopup;
  String? virtualBasedFfsCalculation;

  EngagementType(
      {this.isVideoSessionTestLinkEnabled,
      this.isAddTimezoneAtCreate,
      this.isAlternateDatesAvailable,
      this.maxNumberSpk,
      this.isMissingEmailFlagEnable,
      ...
      this.updatedAt,
      this.venueType,
      this.isDmSigninWithoutJoin,
      this.isCreateEngagemetSpkObject,
      this.hcpMinimumCollab,
      this.isSpeakerEndSessionDisable,
      this.isAlternateVenueEnable,
      this.alternateVenueCount,
      this.skipStartEngagement,
      this.isCreateEngagementSuccessMessage,
      this.speakerSignOnPaperCheckboxDisable,
      this.locationBasedFfsCalculation,
      this.shionogiRoundtableCheck,
      this.maxCoHost,
      this.coHostMessage,
      this.coHostPopUpMessage,
      this.shionogiRoundtableHcpMaxCheck,
      this.isUploadDocument,
      this.isUploadDocumentEnabled,
      this.isExihibitDetails,
      this.displayAndExhibiWorkflow,
      this.isCohostDidnotAttendEnabled,
      this.hideReceiptUploadCheckbox,
      this.virtualWindowUpdatePopup,
      this.virtualBasedFfsCalculation});

  EngagementType.fromJson(Map<String, dynamic> json) {
    isVideoSessionTestLinkEnabled = json['is_video_session_test_link_enabled'];
    isAddTimezoneAtCreate = json['is_add_timezone_at_create'];
    isAlternateDatesAvailable = json['is_alternate_dates_available'];
    maxNumberSpk = json['max_number_spk'];
    isMissingEmailFlagEnable = json['is_missing_email_flag_enable'];
    ...
    isDmSigninWithoutJoin = json['is_dm_signin_without_join'];
    isCreateEngagemetSpkObject = json['isCreateEngagemetSpkObject'];
    hcpMinimumCollab = json['hcp_minimum_collab'];
    isSpeakerEndSessionDisable = json['is_speaker_end_session_disable'];
    isAlternateVenueEnable = json['is_alternate_venue_enable'];
    alternateVenueCount = json['alternate_venue_count'];
    skipStartEngagement = json['skip_start_engagement'];
    isCreateEngagementSuccessMessage =
        json['is_create_engagement_success_message'];
    speakerSignOnPaperCheckboxDisable =
        json['speakerSignOnPaperCheckboxDisable'];
    locationBasedFfsCalculation = json['location_based_ffs_calculation'];
    shionogiRoundtableCheck = json['shionogi_roundtable_check'];
    maxCoHost = json['max_CoHost'];
    coHostMessage = json['coHostMessage'];
    coHostPopUpMessage = json['coHostPopUpMessage'];
    shionogiRoundtableHcpMaxCheck = json['shionogi_roundtable_hcp_max_check'];
    ...
    isCohostDidnotAttendEnabled = json['is_cohost_didnot_attend_enabled'];
    hideReceiptUploadCheckbox = json['hide_receipt_upload_checkbox'];
    virtualWindowUpdatePopup = json['virtualWindowUpdatePopup'];
    virtualBasedFfsCalculation = json['virtual_based_ffs_calculation'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['is_video_session_test_link_enabled'] = isVideoSessionTestLinkEnabled;
    data['is_add_timezone_at_create'] = isAddTimezoneAtCreate;
    data['is_alternate_dates_available'] = isAlternateDatesAvailable;
    data['max_number_spk'] = maxNumberSpk;
    data['is_missing_email_flag_enable'] = isMissingEmailFlagEnable;
    ...
    data['is_dm_signin_without_join'] = isDmSigninWithoutJoin;
    data['isCreateEngagemetSpkObject'] = isCreateEngagemetSpkObject;
    data['hcp_minimum_collab'] = hcpMinimumCollab;
    data['is_speaker_end_session_disable'] = isSpeakerEndSessionDisable;
    data['is_alternate_venue_enable'] = isAlternateVenueEnable;
    data['alternate_venue_count'] = alternateVenueCount;
    data['skip_start_engagement'] = skipStartEngagement;
    data['is_create_engagement_success_message'] =
        isCreateEngagementSuccessMessage;
    data['speakerSignOnPaperCheckboxDisable'] =
        speakerSignOnPaperCheckboxDisable;
    data['location_based_ffs_calculation'] = locationBasedFfsCalculation;
    data['shionogi_roundtable_check'] = shionogiRoundtableCheck;
    data['max_CoHost'] = maxCoHost;
    data['coHostMessage'] = coHostMessage;
    data['coHostPopUpMessage'] = coHostPopUpMessage;
    data['shionogi_roundtable_hcp_max_check'] = shionogiRoundtableHcpMaxCheck;
    ...
    data['is_cohost_didnot_attend_enabled'] = isCohostDidnotAttendEnabled;
    data['hide_receipt_upload_checkbox'] = hideReceiptUploadCheckbox;
    data['virtualWindowUpdatePopup'] = virtualWindowUpdatePopup;
    data['virtual_based_ffs_calculation'] = virtualBasedFfsCalculation;
    return data;
  }
}
...
class ParticipantStatus {
  ...
  ParticipantStatus.fromJson(Map<String, dynamic> json) {
...
class SpeakerData {
  ...
  SpeakerData({this.id, this.email, this.name, this.timeZone});
...
class TypeQuesDetails {
  ...
  TypeQuesDetails.fromJson(Map<String, dynamic> json) {
    labelQueId = json['label_que_id'] != null
        ...
        : null;
    optionId =
        json['option_id'] != null ? OptionId.fromJson(json['option_id']) : null;
    meeting = json['meeting'];
